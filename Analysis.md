...
The model using cylinders, weight and transimission achieved an adjusted R squared value of **`r summary(fit8)$adj.r.squared`**. This is slightly worse than model 3, that did not use transmission. 
